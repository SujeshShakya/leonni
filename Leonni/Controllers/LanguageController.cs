...
namespace Leonni.Controllers
{
    public class LanguageController : LeonniApplicationController
    {
        ...
        public ActionResult AjaxGetLanguages(string sortname, string sortorder, int page, string qtype, string query, int rp)
        {
            ...
            {
                string strAction = "<a href='/Language/Edit/" + totalRows[i].Id + "'>Edit</a>|" +
                                   "<a href='/Language/Delete/" + totalRows[i].Id + "' data-ajax-method='POST' data-ajax-confirm='Are you sure you want to delete this Item ?' data-ajax-complete='RemoveRow(" + totalRows[i].Id + ")' data-ajax='true'>Delete</a>";
